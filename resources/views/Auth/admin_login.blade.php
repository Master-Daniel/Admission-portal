...
<head>
    ...
    <script src="{{ asset('assets/admin/overlayscrollbars/OverlayScrollbars.min.js') }}" ></script>
    ...
    <link href="{{ asset('assets/admin/overlayscrollbars/OverlayScrollbars.min.css') }}" rel="stylesheet">
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4" href="../../../index.html"><img class="me-2" src="{{ asset('assets/admin/img/icons/spot-illustrations/falcon.png') }}" alt="" width="58" /><span class="font-sans-serif fw-bolder fs-5 d-inline-block">falcon</span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                ...
                <form>
                  ...
                  <div class="mb-3"><a class="btn btn-primary d-block w-100 mt-3" href="{{ route('faculty.list') }}" name="submit">Log in</a></div>
                </form>
              </div>
            </div>
          </div>
    ...
    <script src="{{ asset('assets/admin/anchorjs/anchor.min.js') }}" ></script>
    <script src="{{ asset('assets/admin/is/is.min.js') }}" ></script>
    <script src="{{ asset('assets/admin/fontawesome/all.min.js') }}" ></script>
    <script src="{{ asset('assets/admin/lodash/lodash.min.js') }}" ></script>
    <script src="{{ asset('assets/admin/polyfill.io/v3/polyfill.min58be.js') }}?features=window.scroll"></script>
    <script src="{{ asset('assets/admin/list.js/list.min.js') }}" ></script>
